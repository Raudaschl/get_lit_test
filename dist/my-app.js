...
let MyApp = class MyApp extends s {
    firstUpdated() {
        var _a, _b;
        const router = new Router((_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('#outlet'));
